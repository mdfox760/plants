...
class PlantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create plant" do
    assert_difference('Plant.count') do
      post plants_url, params: { plant: { care: @plant.care, name: @plant.name, season: @plant.season } }
    end
  ...
  test "should update plant" do
    patch plant_url(@plant), params: { plant: { care: @plant.care, name: @plant.name, season: @plant.season } }
